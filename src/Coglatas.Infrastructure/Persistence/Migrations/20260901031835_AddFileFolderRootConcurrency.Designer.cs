...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.AnnouncementDraft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.ArtifactEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.ArtifactReportSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileAccessGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileFolder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileFolderPlacement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileFolderRootState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileSelectionSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileSelectionSnapshotItem", b =>
                {
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.AnnouncementDraft", b =>
                {
                    ...
                    b.HasOne("Coglatas.Domain.Entities.Announcement", "PublishedAnnouncement")
                        .WithMany()
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.ArtifactClaim", b =>
                {
                    b.HasOne("Coglatas.Domain.Entities.ArtifactVersion", "ArtifactVersion")
                        .WithMany()
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.ArtifactReportCitation", b =>
                {
                    ...
                    b.HasOne("Coglatas.Domain.Entities.ArtifactReportSection", "Section")
                        .WithMany("Citations")
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.ArtifactReportSection", b =>
                {
                    b.HasOne("Coglatas.Domain.Entities.ArtifactReportDocument", "Document")
                        .WithMany("Sections")
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileAccessGrant", b =>
                {
                    ...
                    b.HasOne("Coglatas.Domain.Entities.User", "RecipientUser")
                        .WithMany()
                        .HasForeignKey("RecipientUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Coglatas.Domain.Entities.User", "RevokedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileFolder", b =>
                {
                    b.HasOne("Coglatas.Domain.Entities.FileFolder", "ParentFolder")
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileFolderPlacement", b =>
                {
                    ...
                    b.HasOne("Coglatas.Domain.Entities.FileFolder", "Folder")
                        .WithMany()
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.FileSelectionSnapshotItem", b =>
                {
                    b.HasOne("Coglatas.Domain.Entities.FileSelectionSnapshot", "SelectionSnapshot")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Coglatas.Domain.Entities.TaskExecutionRun", b =>
                {
                    ...
                    b.HasOne("Coglatas.Domain.Entities.ResearchPlanRevision", "SnapshotResearchPlanRevision")
                        .WithMany()
